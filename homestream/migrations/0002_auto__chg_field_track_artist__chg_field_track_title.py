...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'homestream_track', 'artist', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Track.artist'
        db.alter_column(u'homestream_track', 'artist', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'Track.title'
        db.alter_column(u'homestream_track', 'title', self.gf('django.db.models.fields.CharField')(max_length=60))
